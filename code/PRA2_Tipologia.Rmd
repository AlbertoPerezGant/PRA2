...
par(mfrow=c(3,2))
pie(table_sex, labels = lbls_sex, main="Num. de mujeres y hombres")
pie(table_cp, labels = lbls_cp, main="Num. pac.según dolor de pecho")
pie(table_fbs, labels = lbls_fbs, main="Num. pac. con azúcar alto")
pie(table_restecg, labels = lbls_restecg, main="Num. pac. según resultados ECG")
pie(table_exng, labels = lbls_exng, main="Num. pac. con angina por ejercicio")
